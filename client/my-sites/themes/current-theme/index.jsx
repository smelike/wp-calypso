...
import { getActiveTheme, getThemeInfoFromOriginalSource } from 'state/themes/selectors';
...
export default connect(
	( state, { siteId } ) => {
		...
		return {
			currentTheme: getThemeInfoFromOriginalSource( state, siteId, currentThemeId ),
		};
	}
